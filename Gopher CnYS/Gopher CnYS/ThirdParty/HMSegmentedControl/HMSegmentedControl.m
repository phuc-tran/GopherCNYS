...
- (void)commonInit {
    ...
    self.opaque = NO;
    _selectionIndicatorColor = [UIColor colorWithRed:64.0f/255.0f green:222.0f/255.0f blue:172.0f/255.0f alpha:1.0f];
    
    self.selectedSegmentIndex = 0;
    self.segmentEdgeInset = UIEdgeInsetsMake(0, 2, 0, 2);
...
- (NSDictionary *)resultingSelectedTitleTextAttributes {
    NSDictionary *defaults = @{
                               NSFontAttributeName : [UIFont fontWithName:@"HelveticaNeue-Light" size:13.0f],
                               NSForegroundColorAttributeName : [UIColor colorWithRed:64.0f/255.0f green:222.0f/255.0f blue:172.0f/255.0f alpha:1.0f],
                               };
