...
-(void) pickerSelector:(SBPickerSelector *)selector selectedCountryName:(NSString *)value countryCode:(NSString*)code index:(NSInteger)idx;
-(void) pickerSelector:(SBPickerSelector *)selector intermediatelyCoutryName:(NSString *)value countryCode:(NSString*)code index:(NSInteger)idx;
-(void) pickerSelector:(SBPickerSelector *)selector intermediatelySelectedValue:(id)value atIndex:(NSInteger)idx;
-(void) pickerSelector:(SBPickerSelector *)selector intermediatelyDateValue:(NSDate *)value atIndex:(NSInteger)idx;
...
@interface SBPickerSelector : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate, CountryPickerDelegate>
{
